...
var styleAttr__namespace = /*#__PURE__*/_interopNamespace(styleAttr);
var querySelectorAll__default = /*#__PURE__*/_interopDefaultLegacy(querySelectorAll);
...
var D3Element = /** @class */ (function () {
    function D3Element(nodeName, initialValues, isRoot) {
        ...
        this.setAttribute = function (name, value) {
            ...
            if (name === "style") {
                if (isString(value)) {
                    var styles = styleAttr__namespace.parse(value);
        ...
        this.Mounter = react.forwardRef(function (props, ref) {
            var _a = react.useState({}); _a[0]; var setFlush = _a[1];
    ...
    D3Element.prototype.querySelectorAll = function (selector) {
        ...
        return querySelectorAll__default['default'](selector, this);
    };
    ...
    D3Element.prototype.toReact = function () {
        return react.createElement(this.Mounter, {
            ref: this.mountRef,
            key: this.id,
        });
    };
    D3Element.prototype.renderElement = function () {
        ...
        return react.createElement(this.nodeName, __assign(__assign(__assign({}, attrs), Object.keys(this.eventListeners).reduce(function (acc, k) {
